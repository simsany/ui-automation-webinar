Feature: EPAM job searching
  ...
  Scenario Outline: I search for a job
    ...
    And I want to see the given "<department>"
    ...
    And I want to see the "<city>" in the job description
    And I want to see postion: "<position>" in the job description
